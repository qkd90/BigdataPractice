...
<head>
    ...
    <script type="text/javascript" src="/js/proManage/agentTicketLineManage.js"></script>
    <title></title>
...
<div id="tabs" class="easyui-tabs" fit="true">
    <div id="ticket" title="门票" data-type="recharge">
            ...
            <div id="ticket_tool">
                ...
                <div style="padding:2px 5px;">
                    <form action="" id="ticket_form">
                        ...
                        <a href="javascript:void(0)"  class="easyui-linkbutton"  onclick="TicketLineManage.doSearchTicket()">查询</a>
                        <a href="javascript:void(0)"  class="easyui-linkbutton"  onclick="TicketLineManage.clearTicket()">清空</a>
                    </form>
                </div>
                <%--<div style="padding:2px 5px;">--%>
    ...
    <div id="agentLine" title="线路" data-type="consume" >
        <div title="" class="easyui-layout" data-options="fit:true,border:false" style="width:100%;height:100%;">
            <!-- 表格工具条 始 -->
            <div id="line_tool">
                <div style="padding:2px 5px;">
                    <form action="" id="consume_form">
                        ...
                        <a href="javascript:void(0)" id="consume_search" class="easyui-linkbutton"  onclick="TicketLineManage.doSearch('show_dg')">查询</a>
                    </form>
                </div>
                <div style="padding:2px 5px;">
