...
<head>
    ...
    <script type="text/javascript" src="/js/order/ctripOrder/ctripOrderDetail.js"></script>
</head>
<style type="text/css">
  body {
    font-size: 14px;
                        ...
                        <td class="detail-opt" style="width: 80px;">
                            <c:choose>
                                <c:when test="${detail.status == 'SUCCESS'}">
                                    <a javascript:void(0); style="color:#0000ff" onclick="CliendOrderDetail.doRefundOtaCtrip(${detail.id})">申请退款</a>
                                </c:when>
                                <%--没涉及金额的就统一用CANCELED--%>
                                <%--有涉及金额就是REFUNDED--%>
