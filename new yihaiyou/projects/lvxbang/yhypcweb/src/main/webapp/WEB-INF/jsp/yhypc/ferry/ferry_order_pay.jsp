        ...
        <div class="orderPay clearfix ">
            <div class="payTop">
                ...
                <div class="order_mess">
                    <h3>${order.flightLineName}</h3>
                    <p>
                        <span class="l_title">出发日期：</span>
                        <span class="s_fir"></span>
                        <span class="date">${order.departTime}</span>
                        <%--<span class="week">星期六（Sat）</span>--%>

                        <span class="roomNum"><label>购买数量：</label>${fn:length(order.ferryOrderItemList)}</span>
							<span class="total ferrypay">订单总额：
								<span class="rmb">¥</span><span class="num">${order.amount}</span>
							</span>
                    </p>
                    <p>
...
<script type="text/javascript" src="/js/ferry/ferry_order_pay.js"></script>
