  ...
  <c:forEach items="${order.orderDetails}" var="detail">
    <div class="detail-panel">
      ...
      <div style="margin-top: 10px;">
        <strong class="title">游客信息</strong>
        ...
        <tr>
          ...
          <td>
            <s:if test="#ferryOrder.status == @com.data.data.hmly.service.order.entity.enums.OrderStatus@SUCCESS">
              <a javascript:void(0); style="color:#0000ff" onclick="CliendOrderDetail.doDefundFerry(<s:property value="#ferryOrder.id"/>)">申请退款</a>
            </s:if>
            <s:elseif test="#ferryOrder.status == @com.data.data.hmly.service.order.entity.enums.OrderStatus@FAILED || #ferryOrder.status == @com.data.data.hmly.service.order.entity.enums.OrderStatus@PAYED">
              <a javascript:void(0); style="color:#0000ff" onclick="CliendOrderDetail.doFailOrderRefundFerry(<s:property value="#ferryOrder.id"/>)">退款</a>
            </s:elseif>
            <s:else>
              无
            </s:else>
