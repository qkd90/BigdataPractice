...
<div id="orderDetailDg" class="easyui-dialog" title="账单明细"
    ...
    <iframe name="orderDetailIframe" id="orderDetailIframe" scrolling="no" frameborder="0"  style="width:100%;height:520px;border-width:0;"></iframe>
</div>
<!-- 账单明细窗口 终 -->

</body>
<script type="text/javascript" src="/js/order/order/shenzhouOrderbill.js"></script>
</body>
</html>
