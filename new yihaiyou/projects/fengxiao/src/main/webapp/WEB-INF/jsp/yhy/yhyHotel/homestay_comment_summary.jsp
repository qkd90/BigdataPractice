...
<body class="homestayComment includeTable">
<%@include file="../../yhy/yhyCommon/common_header.jsp" %>
<div class="roomset container">
    <div class="search clearfix">
        <div class="form-group">
            <input type="text" name="category" id="ipt_targetName" value="" placeholder="房型名称" autocomplete="off">
        </div>
        <div class="form-group">
...
<script src="/js/yhy/yhyHotel/homestay_comment_summary.js"></script>
</html>