...
<head>
    ...
    <script type="text/javascript" src="/js/proManage/agentProductManage.js"></script>
    <title></title>
...
<div id="tabs" class="easyui-tabs" fit="true">
            ...
            <div id="ticket_tool">
                ...
                <div style="padding:2px 5px;">
                    <form action="" id="ticket_form">
                        ...
                        <a href="javascript:void(0)"  class="easyui-linkbutton"  onclick="AgentProduct.doSearchTicket()">查询</a>
                        <a href="javascript:void(0)"  class="easyui-linkbutton"  onclick="AgentProduct.clearTicket()">清空</a>
                    </form>
                </div>
                <%--<div style="padding:2px 5px;">--%>
    ...
    <div id="AgentProduct" title="线路商品" data-type="consume" >
        <div title="" class="easyui-layout" data-options="fit:true, border:false" style="width:100%;height:100%;">
            <!-- 表格工具条 始 -->
            <div id="line_tool">
                <div style="padding:2px 5px;">
                    <form action="" id="line_form">
                        <input id="line_keyword" class="easyui-textbox" data-options="prompt:'线路名称关键词'" style="width:200px;">
                        <a href="javascript:void(0)" id="consume_search" class="easyui-linkbutton"  onclick="AgentProduct.doSearchLine()">查询</a>
                        <a href="javascript:void(0)"  class="easyui-linkbutton"  onclick="AgentProduct.clearLine()">清空</a>
                    </form>
                </div>
                <div style="padding:2px 5px;">
