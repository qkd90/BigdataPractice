...
<head>
  ...
  <title>${city.name}自助游_${city.name}自由行-旅行帮</title>
  <meta name="keywords" content="${city.name}自助游,${city.name}自由行,${city.name}周边自助,国内自助,出境自助"/>
  <meta name="description" content="旅行帮提供丰富、优质的${city.name}自助旅游线路及报价，并搭配多种玩法推荐。${city.name}自助游来旅行帮！"/>
...
<body myname="selfTourList" class="lines_List index1000">
  ...
  <div class="main fl">
          ...
          <dl class="clearfix poi_selecters">
            ...
            <dd class="oneLine this_height startdd">
              <ul class="list_3 clearfix" id="startCity">
                <c:choose>
                  <c:when  test="${startCity != null && startCity.id != null}">
                  <li>
                    <a class="input_hide" href="javascript:void(0);" data-id="">全部</a>
                  </li>
                  <li class="filter_input ">
                    <a class="cur_city" href="javascript:void(0);" data-id="${startCity.id}">${startCity.name}</a>
                  </li>
                  </c:when>
                  <c:otherwise>
                    <li>
        ...
        <div class="clearfix prop_item " id="startDay">
          <dl>
            ...
            <dd class="oneLine">
              <div class="calendar">
                <div>
                  <input id="begin_date" type="text" value="${startDate}" readonly style="color: rgb(153, 153, 153);" onfocus="WdatePicker({minDate:'%y-%M-{%d}',onpicked:function(){$(this).change()}})">                                        <input type="hidden" id="hd_begin_date" name="hd_begin_date" value="">
                </div>
                <div>—</div>
                <div>
                  <input id="end_date" type="text" value="${startDate}" readonly style="color: rgb(153, 153, 153);" onfocus="WdatePicker({minDate:'#F{$dp.$D(\'begin_date\',{d:1})}',onpicked:function(){$(this).change()}})">                                        <input type="hidden" id="hd_end_date" name="hd_end_date" value="">
                </div>
    ...
    <div id="J_Entrance_Wrap" class="entrance-wrap">
      <div id="J_Entrance_Left" class="entrance-left">
        ...
        <a href="${PLAN_PATH}" target="_blank" class="entrance-left-href"></a>
      </div>
              ...
              <div class="search_pkg_row clearfix">
                ...
                <div class="search_pkg_depart" style="margin-bottom: 0;">
                  <div class="J_DepartCity search_ctrl search_ctrl_inp search_ctrl_city" style="width: 300px;">
                    ...
                    <input id="input_planId" class="search_ctrl_inp_input clickinput" name="departName" type="text" value="${city.name}" autocomplete="off">
    ...
    <div class="galleryblock local" id="block_floor_0">
      <div class="top clearfix">
        <div class="productname fl"><span class="cityname">${city.name}</span>热门定制精品</div>
        <div class="moredetail fr">
          <a  href="/custom_made_${city.id}.html" target="_blank">更多定制精品 &gt;</a>
        </div>
      </div>
...
<script type="text/html" id="tpl-hot-customMade-item">
  <li class="gallery-list-item fl first ">
    <div class="imgblock">
      <a title="<{{name}}>{{appendTitle}}" href="${CUSTOM_PATH}/line_detail_{{id}}.html" target="_blank">
