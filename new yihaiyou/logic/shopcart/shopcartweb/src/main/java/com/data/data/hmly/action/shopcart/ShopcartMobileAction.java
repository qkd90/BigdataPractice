 ...
 */
public class ShopcartMobileAction extends JxmallAction implements ModelDriven<Product> {
	...
	public Result mobileorder() {
		productInfo = shopCartService.orderStraight(product, priceDateId);
		if (productInfo == null) {
			logger.error("查询不到Product#" + product.getId());
//			return redirect("/mobile/index/index.jhtml");
		}
		return dispatch();
	}
