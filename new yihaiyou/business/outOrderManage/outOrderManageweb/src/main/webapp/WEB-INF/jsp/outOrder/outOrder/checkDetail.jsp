...
<head>
    ...
    <title>录入外接订单</title>
    <script type="text/javascript" src="/js/outOrder/outOrder/checkDetail.js"></script>
</head>
<style type="text/css">
  body {
    font-size: 14px;
      ...
      <div style="width: 100%;height: 5%;padding: 15px;">
          ...
          <div style="width: 30%;float: right;">
              ...
              <div style="width: 35%; float: left;text-align: right;">
                  <a id="btn_confimOrder" onclick="CheckDetail.confimOrder()" class="easyui-linkbutton" >支付订单</a>
                  <a id="btn_applyCancel" onclick="CheckDetail.applyCancelDialog()" class="easyui-linkbutton" >申请取消</a>
              </div>
              <div style="width: 65%; float: right">
                  <a class="easyui-linkbutton" id="btn_msgAgain" style="margin-left: 18px;" onclick="CheckDetail.sendMsgAgain()" >短信重发(<span id="msgCount">${jszxOrder.msgCount}</span>)</a>
                  <a class="easyui-linkbutton" style="margin-left: 18px;" onclick="CheckDetail.backParent()" >后退</a>
              </div>
      ...
      <div style="width: 100%;height: 55%;">
              ...
              <div style="width: 100%;height: 11%;padding: 15px 15px;background-color: #f7f7f7">
                  ...
                  <div style="width: 25%;height: 100%;float: left">
                      ...
                      <div style="font-size: 16px;font-weight: bolder;margin-top: 3px;">
                          ${jszxOrder.product.name}
                      </div>
                  </div>
                  <div style="width: 25%;height: 100%;float: left">

                          <div class="showByStatus" style="font-size: 12px;">
                              付款日期：<label id="payDateId" data-value="${jszxOrder.updateTime}"></label>
                          </div>
                          <div  style="font-size: 12px;margin-top: 2px;">
                              分销商：<label>${jszxOrder.user.account}</label>
                          </div>
                  </div>
                  <div style="width: 25%;height: 100%;float: left" >
                  ...
                  <div style="width: 20%;height: 100%;float: right">
                      <div>
                          <label style="font-size: 14px;">付款状态：</label>
