...
public class TbTransportation extends com.framework.hibernate.util.Entity {
    private long id;
    private String name;
    private Double lng;
    private Double lat;
    ...
    @Basic
    @Column(name = "city_code", nullable = true, insertable = true, updatable = true, length = 255)
    ...
    @Basic
    @Column(name = "telephone", nullable = true, insertable = true, updatable = true, length = 45)
    ...
    @Basic
    @Column(name = "data_source_url", nullable = true, insertable = true, updatable = true, length = 200)
    ...
    @Basic
    @Column(name = "data_status", nullable = true, insertable = true, updatable = true)
    ...
    public boolean equals(Object o) {
        ...
        TbTransportation that = (TbTransportation) o;
