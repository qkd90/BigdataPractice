package com.data.data.hmly.service.pay.exinfo;

import com.data.data.hmly.service.pay.config.DirectPayWebCfg;
import com.data.data.hmly.service.pay.util.MD5;
import com.data.data.hmly.service.pay.util.httpclient.HttpProtocolHandler;
import com.data.data.hmly.service.pay.util.httpclient.HttpRequest;
import com.data.data.hmly.service.pay.util.httpclient.HttpResponse;
import com.data.data.hmly.service.pay.util.httpclient.HttpResultType;
...
public class AlipaySubmit {
	...
	public String KEY = propertiesManager.getString("KEY");
	public String INPUT_CHARSET = propertiesManager.getString("INPUT_CHARSET");
	...
	public String query_timestamp() throws MalformedURLException, DocumentException, IOException {
		...
		String strUrl = ALIPAY_GATEWAY_NEW + "service=query_timestamp&partner=" + PARTNER + "&_INPUT_CHARSET"
				+ INPUT_CHARSET;
