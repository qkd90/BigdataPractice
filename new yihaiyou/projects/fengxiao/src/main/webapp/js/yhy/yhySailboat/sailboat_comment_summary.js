...
var SailboatCommentSummary = {
    ...
    initOrderList: function() {
        SailboatCommentSummary.commentListTable = $(".table-bordered").DataTable( {
            ...
            "columns": [
                ...
                { "title": "票型名称", data:'targetName'},
                { "title": "评价数", data:'count', class: 'text-center'},
                { "title": "操作", data:null, class: 'text-center', render: function(data, type, row, meta) {
                    return '<a href="/yhy/yhyMain/toSailboatCommentList.jhtml?priceTypeId='+ row.priceId +'">评价详情</a>';
                }},
            ]
        });
    },
    ...
    openOrderDetail: function(detailId, id) {
        window.location.href = "/yhy/yhyMain/toSailboatCommentSummaryDetail.jhtml?orderId="+id + "&orderDetailId=" + detailId;
    }
};
