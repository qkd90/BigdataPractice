 ...
 *       &lt;sequence>
 *         &lt;element name="ImageItem" type="{}ImageItemType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ImageItemsType {
    ...
    protected List<ImageItemType> imageItem;
     ...
     * 
     */
    public List<ImageItemType> getImageItem() {
        if (imageItem == null) {
            imageItem = new ArrayList<ImageItemType>();
        }
