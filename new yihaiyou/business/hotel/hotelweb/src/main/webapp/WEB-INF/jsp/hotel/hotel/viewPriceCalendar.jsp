				...
				<div class="price-calendar-info">
					<div class="outDiv clearfix">
						<div class="form-group yhy-form-group">
							...
							<input type="text" id="valuationModels" readonly="readonly" class="form-control yhy-form-ctrl readonly" placeholder="-">
						</div>
					</div>
					<div class="outDiv clearfix">
						<div class="form-group yhy-form-group">
					...
					<div class="outDiv clearfix">
						<div class="form-group yhy-form-group">
							<input type="hidden" id="hotelPriceId" value="${typePriceId}">
							...
							<button type="button" class="btn btn-default add-price-btn" onclick="ViewPriceCalendar.setPriceData()">添加</button>
...
<script src="/js/hotel/viewPriceCalendar.js"></script>
</html>