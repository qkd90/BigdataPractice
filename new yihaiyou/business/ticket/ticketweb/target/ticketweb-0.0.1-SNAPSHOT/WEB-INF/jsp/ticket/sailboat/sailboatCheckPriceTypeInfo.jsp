...
<div class="roomset sailBaseMess">
  <form role="form" id="ticketPriceForm" action="" method="post" enctype="multipart/form-data">
    <input type="hidden" id="is_where" value="bg_platform">
    ...
    <div class="mineBtn">
      <a class="btn btn-default btn1" onclick="SailboatPriceType.doCancel()">取消</a>
...
<script src="/js/sailboat/ticketPriceInfoEdit.js"></script>
</html>
