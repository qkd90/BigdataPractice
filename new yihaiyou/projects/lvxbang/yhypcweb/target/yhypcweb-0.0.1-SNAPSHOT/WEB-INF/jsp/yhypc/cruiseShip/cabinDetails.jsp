    ...
    <div class="wrap">
        ...
        <div class="another">
            ...
            <ul class="another-body clearfix">
                <c:forEach items="${cruiseShipProject.cruiseShipProjectClassify.cruiseShipProject}" var="cruiseShipProject" begin="0" end="2">
                    <li class="pull-left">
                        <img class="pull-left" src="../images/product_details_img.png">
                        <div class="another-txt pull-left">
                            <a href="#" class="title">${cruiseShipProject.name}</a>
                            <div class="txt-tips clearfix">
                                <label class="pull-left">楼层</label>
                                <span class="pull-left">${cruiseShipProject.level}层</span>
                            </div>
                            <div class="txt-tips clearfix">
                                <label class="pull-left">容纳</label>
                                <span>${cruiseShipProject.peopleNum}人</span>
                            </div>
                        </div>
                    </li>
                </c:forEach>
