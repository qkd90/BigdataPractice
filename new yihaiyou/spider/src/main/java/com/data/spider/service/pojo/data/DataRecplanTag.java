 ...
 */
@Entity
@Table(name = "data_recplan_tag")
public class DataRecplanTag extends com.framework.hibernate.util.Entity {
    private int id;
    ...
    @Basic
    @Column(name = "city_code", nullable = true, insertable = true, updatable = true)
    ...
    public boolean equals(Object o) {
        ...
        DataRecplanTag that = (DataRecplanTag) o;
