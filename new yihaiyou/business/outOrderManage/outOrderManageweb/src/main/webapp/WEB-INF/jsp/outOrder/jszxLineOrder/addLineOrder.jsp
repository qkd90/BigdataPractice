...
<head>
    ...
    <script type="text/javascript" src="/js/outOrder/lineOrder/addLineOrder.js"></script>
...
<form id="editForm" method="post">
    ...
    <input id="ipt_line" type="hidden" value="${line.id}">
      <input type="hidden" id="hipt_lineType" value="${line.lineType}">
      <input type="hidden" id="hipt_lineConfim" value="${line.confirmAndPay}">
      <input type="hidden" id="hipt_proType" value="${line.proType}">
      <input type="hidden" id="hipt_goway" value="${line.goWay}">
      <input type="hidden" id="hipt_validDay" value="${line.validOrderDay}">
  <div class="coupon_class">
    <label class="label_class">订单类型:</label>
    <label id="la_lineType">
    </label>
      <input type="text" class="calender_class" id="startTime_'+ rowData.type +'_'+ rowData.id +'" onkeyup="AddLineOrder.getChangeValue('+ index +','+ rowData.id +')" style="width: 105px;height: 22px;" temp-value="0">
  </div>
  <div class="coupon_class">
    ...
    <div class="coupon_class" id="idcard_div">
        <label class="label_class">身份证:</label>
        <input id="ipt_idCard" class="easyui-textbox" name="idCard" data-options=""  style="width:200px"/>
    </div>
    <div class="coupon_class">
        <label class="label_class">备注:</label>
        <input id="ipt_source" class="easyui-textbox" name="source" data-options="multiline:true, validType:'maxLength[500]'" style="width:600px; height:80px;"/>
    </div>
...
<div class="botton_class">
  <a class="easyui-linkbutton" onclick="AddLineOrder.saveOutOrder()" >提交</a>
  <a class="easyui-linkbutton" onclick="AddLineOrder.cancelOutOrder()" >取消</a>
</div>
