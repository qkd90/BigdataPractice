...
public class StringUtil extends StringUtils {
	 ...
	 * @return
	 */
	public static int getIntFromObj(Object o) {
		int resInt = 0;
		if (o != null) {
			String strVal = ObjectUtils.getDisplayString(o);
			if (StringUtils.isNumeric(strVal)) {
				resInt = Integer.valueOf(strVal);
			}
		}
	 ...
	 * @return
	 */
	public static int getIntFromDouble(Object o) {
		int resInt = 0;
		if (o != null) {
			String strVal = ObjectUtils.getDisplayString(o);
			resInt = (int) (Double.parseDouble(strVal));
		}
