...
mTicketIndexModule.controller('mTicketIndexCtrl', function($scope, $http, $state, Banner, storage, Position) {
    ...
    // 获取新app门票首页数据
    $http.post(LXB_URL.mTicketIndexData, {
        ...
        'scenicSearchRequest.priceRange[0]': 1
