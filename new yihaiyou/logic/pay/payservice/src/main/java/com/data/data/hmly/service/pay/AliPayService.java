...
public class AliPayService {
    ...
    /**
     *
     * @param refundDate    必填，格式：年[4位]月[2位]日[2位]，如：20100801
     * @param batchNo       必填，退款批次号(batch_no)，必填(时间格式是yyyyMMddHHmmss+数字或者字母)
     ...
     * @return
     */
    public String doAliRefund(String refundDate, String batchNo, String batchNum, String detailData) {
    ...
    public Map<String, String> doRefundBackParam(HttpServletRequest request) {
        //获取支付宝POST过来反馈信息
