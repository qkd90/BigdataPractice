...
<body style="margin:0;padding:0px 3px 0px 0px;">
    ...
    <table class="billSummaryInfo">
        <tr>
            ...
            <td class="lbl">商户:</td>
            <td>${orderBillSummary.companyUnit.name}</td>
        </tr>
        <tr>
            <td class="lbl">当期结算额:</td>
            <td>${orderBillSummary.totalBillPrice}</td>
            <td class="lbl">当期退款额:</td>
            <td>${orderBillSummary.refundPrice}</td>
    ...
    <table id="refundDetailGrid" style="width:100%; height:430px;"></table>
</body>
<script type="text/javascript" src="/js/order/order/billDetail.js"></script>
</body>
</html>
