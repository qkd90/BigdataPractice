...
<head>
    ...
    <script type="text/javascript" src="/js/outOrder/sailboat/index.js"></script>
    <title>游艇帆船订单管理</title>
    <style>
        .labelClass {
            float: left;
            margin-right: 5px;
...
<div id="activity_tab" class="easyui-tabs" fit="true" ShowHeader="false">
    <div id="sailboat" title="游艇帆船订单">
            ...
            <div id="client_sailboat_tool">
                <form action="" id=client_sailboat_form">
                    <div style="padding:5px 5px 3px 5px;">
                        <input id="client_sailboat_orderNo" class="easyui-textbox" data-options="prompt:'订单编号'" style="width:150px;"/>
                        <input id="client_sailboat_proName" class="easyui-textbox" data-options="prompt:'船只名称'" style="width:150px;">
                        <input id="client_sailboat_createby" class="easyui-textbox" data-options="prompt:'下单帐号'" style="width:100px;"/>
