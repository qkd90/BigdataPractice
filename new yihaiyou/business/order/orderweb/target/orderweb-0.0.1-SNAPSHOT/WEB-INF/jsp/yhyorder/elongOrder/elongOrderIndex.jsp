...
<head>
    ...
    <script type="text/javascript" src="/js/order/elongOrder/elongOrderIndex.js"></script>
            ...
            <form action="" id=client_form">
                <div style="padding:5px 5px 3px 5px;">
                    ...
                    <input id="client_status" class="easyui-combobox" data-options="prompt:'订单状态',editable:false,
                        ...
                        textField: 'value',
                        panelHeight: 'auto',
                         data:　ElongOrderManage.orderStatus
                        " style="width:150px;">
                    ...
                    <a href="javascript:void(0)" id="client_ship_search" class="easyui-linkbutton"  onclick="ElongOrderManage.doSearch()">查询</a>
                    <a href="javascript:void(0)" id="client_ship_clear" class="easyui-linkbutton"  onclick="ElongOrderManage.clearForm()">重置</a>
                </div>
