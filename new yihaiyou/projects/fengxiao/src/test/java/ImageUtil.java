        ...
        if(imgFile.exists()){
            try {
                ...
                if(suffix == null || types.toLowerCase().indexOf(suffix.toLowerCase()) < 0) {
                    System.out.println("Sorry, the image suffix is illegal. the standard image suffix is {}.");
...
//            log.warn("the image is not exist.");
    ...
    public static void main(String[] args) {
        new ImageUtil().thumbnailImage("E:\\ideaworkspace\\data\\projects\\fengxiao\\src\\test\\testfile\\Tulips.jpg", 100, 150, true);
    }
