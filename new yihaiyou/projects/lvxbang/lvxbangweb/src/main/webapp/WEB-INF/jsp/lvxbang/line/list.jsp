...
<head>
  ...
  <link href="./私人定制_定制旅游_自由行-旅行帮_files/WdatePicker.css" rel="stylesheet" type="text/css">
</head>
<body myname="Lines" class="lines_List index1000">
...
<div class="contentcontainer clearfix">
  ...
  <div class="main fl">
    ...
    <div class="cate_nav mb_10 an_mo" liwithhan="category_筛选项">
      ...
      <div class="prop_list prop-list-new clearfix">
        ...
        <!-- 出发城市 -->
        <div class="clearfix prop_item needed_filter mult_select hasMoreChoice" id="startCity">
          <dl class="clearfix poi_selecters">
            ...
            <dd class="oneLine">
              <ul class="list_3 clearfix">
                ...
                <li class="filter_input ">
                  <a href="javascript:void(0);" data-id="460200">三亚</a>
                </li>
                <li class="filter_input ">
        ...
        <div class="clearfix prop_item needed_filter mult_select hasMoreChoice">
          <dl class="clearfix poi_day_selecter xc_days">
            <dt><span class="list_gaiban_icon x_cp_tese"></span>产品特色</dt>
            <dd class="oneLine">
              <ul class="list_3 clearfix duration_select" id="adv_selcts_5">
                <li class="filter_input">
                  <a class="input_hide cur_city" href="javascript:void(0);" onclick="clear_selected('duration')" rel="nofollow">全部 </a>
                </li>
                <li class="filter_input">
                  <input type="checkbox" value="2017" name="ad_option">
                  <a href="javascript:void(0);" rel="nofollow">海景房</a>
                </li>
                <li class="filter_input">
                  <input type="checkbox" value="1536" name="ad_option">
                  <a href="javascript:void(0);" rel="nofollow">纯玩无购物</a>
                </li>
              </ul>
            </dd>
          </dl>
    ...
    <div id="J_Entrance_Wrap" class="entrance-wrap">
      <div id="J_Entrance_Left" class="entrance-left">
        <div class="entrance-left-pic"></div>
        <a href="http://super.tuniu.com" target="_blank" class="entrance-left-href"></a>
      </div>
      <div id="J_Entrance_Right" class="entrance-right ">
        <div class="entrance-header clearfix">
          <h3 data-type="2" class="entrance-switcher-tab J_switcher_tab fl cur">私人订制</h3>
          </div>
        <div class="entrance-container">
          <div id="J_Entrance_Ranked" class="entrance-ranked-wrap" style="display: none;"><ul class="rank-list">  </ul></div>
          <div class="J_SearchEntrance search_group search_pkg clearfix">
            <div class="search_pkg_form">
              <div class="search_pkg_row clearfix">
                <!--出发城市-->
                <div class="search_pkg_depart" style="margin-bottom: 0;">
                  <div class="J_DepartCity search_ctrl search_ctrl_inp search_ctrl_city" style="width: 300px;">
                    <div class="search_ctrl_inp_label">出发地</div>
                    <input id="input_planId" class="search_ctrl_inp_input clickinput" name="departName" type="text" value="广州" autocomplete="off">
            ...
            <div class="search_pkg_buttons">
              <!--submit-->
              <div class="J_SearchSubmit search_ctrl search_submit search_pkg_submit">
                <a href="javascript:;" class="search_btn_entrance" onclick="SearcherBtn.scenicByDest()">原创线路</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="galleryblock local" id="block_floor_0">
      <div class="top clearfix">
        <div class="productname fl"><span class="cityname">厦门</span>热门当地玩乐</div>
        <div class="moredetail fr">
          <a onclick="_gaq.push(['_trackEvent','列表页','点击','底部_当地玩乐_产品推荐_更多'])" href="http://www.tuniu.com/g906/local-gz-0/" target="_blank">更多当地玩乐 &gt;</a>
        </div>
      </div>
    ...
    <div class="galleryblock ticket" id="block_floor_1">
      <div class="top clearfix">
        <div class="productname fl"><span class="cityname">厦门</span>热门景点</div>
        <div class="moredetail fr">
          <a class="more_list" data-href="${SCENIC_PATH}/scenic_list.html?cityCode=" target="_blank" href="javascript:;">更多景点 &gt;</a>
        </div>
      </div>
      <div class="gallery-lists">
    ...
    <div class="galleryblock hotel" id="block_floor_2">
      <div class="top clearfix">
        <div class="productname fl"><span class="cityname">厦门</span>热门酒店</div>
        <div class="moredetail fr">
          <a class="more_list" data-href="${HOTEL_PATH}/hotel_list.html?hotelCityId=" target="_blank" href="javascript:;">更多酒店 &gt;</a>
        </div>
      </div>
      <div class="gallery-lists">
  ...
  <div class="side fr">
    ...
    <%--</div>--%>
    <!-- 小帮订制 -->
    <a target="_blank" href="/lvxbang/customRequire/fill.jhtml" rel="nofollow" title="小帮定制" class="niuren_ding">
    ...
    <div class="aside_tab order_tab">
      <ul class="tabs clearfix">
        ...
        <li class="order_tab_flight">机票</li>
      ...
      <ul class="tab_contents">
        <li class="current">
          ...
          <div class="J_trainHotel" style="display: none;">
            <form method="POST" action="http://diy.tuniu.com/train-hotel/pkg/" id="train_hotel_form" target="_blank">
              <div class="form_field">
                <label>出发地：</label>
                <input id="airplane_origin" class="field_input" placeholder="选择出发地" type="text" autocomplete="off" code="602" value="广州">
              </div>
              <div class="form_field">
                <label>目的地：</label>
                <input id="airplane_destination" class="field_input" placeholder="选择目的地" type="text" autocomplete="off">
              </div>
              <div class="form_field">
                <label>出发时间：</label>
                <input class="field_input" id="d11" type="text">
              ...
              <div class="hide">
                ...
                <input type="hidden" name="isSingleTrip" value="0">
                <input type="hidden" name="wangfan" value="1">
                <input type="hidden" name="searchCookieName" value="tuniu_thPkgSearch">
              </div>
            </form>
          </div>
        </li>
        <li>
          <form method="POST" id="flightSearchForm" action="${TRAFFIC_PATH}/lvxbang/traffic/toFlight.jhtml" target="_blank">
            ...
            <div class="form_field sho">
              <label>出发地：</label>
              <input id="flight_origin" class="field_input portinput clickinput" placeholder="选择出发地" type="text" autocomplete="off" value="广州" name="leaveCityName">
              <div class="posiA Addmore Addmore2 categories_Addmore2"></div>
            </div>
            <div class="form_field sho">
              <label>目的地：</label>
              <input id="flight_destination" class="field_input portinput clickinput" placeholder="选择目的地" type="text" autocomplete="off" value="三亚" name="arriveCityName">
            ...
            <div class="form_field">
              <label title="成人票≥12周岁，不支持70周岁（含）以上乘机人购票。">成人：</label>
              <select id="flight_adult_num" class="field_select w_52">
            ...
            <div class="form_field">
              <label title="2周岁≤儿童票＜12周岁，不支持2周岁以下乘机人购票。">儿童：</label>
              <select id="flight_child_num" class="field_select w_52">
                <option>0</option>
                <option>1</option>
                <option>2</option>
              </select>
        ...
        <li class="">
          ...
          <div class="J_internalHotel">
            <form method="post" id="hotelSearchForm" target="_blank" action="${HOTEL_PATH}/hotel_list.html">
              <div class="form_field">
                <label>入住城市：</label>
                <input id="hotel_origin" class="field_input input clickinput" placeholder="城市名称" type="text" autocomplete="off" name="cities">
                <div class="posiA Addmore Addmore2 categories_Addmore2" style="top: 100px;"></div>
              </div>
              <div class="form_field">
                <label>关键词：</label>
                <input class="field_input input input01 clickinput" placeholder="酒店名/位置/品牌" type="text" name="name" data-url="http://pj.hotel.test.lvxbang.com/lvxbang/hotel/suggest.jhtml">
          ...
          <div class="J_externalHotel" style="display: none;">
            <form method="GET" id="external_hotel_form" target="_blank">
              ...
              <div class="hide">
                ...
                <input type="hidden" name="label" value="searchlist">
              </div>
            </form>
          </div>
        ...
        <li class="">
          <form id="trainSearchForm" method="POST" action="${TRAFFIC_PATH}/lvxbang/traffic/toTrain.jhtml" target="_blank">
            ...
            <div class="form_field sho">
              <label>出发站：</label>
              <input id="train_origin" class="field_input clickinput portinput" type="text" autocomplete="off" value="广州" name="leaveCityName">
              <div class="posiA Addmore Addmore2 categories_Addmore2" style="top: 27px;"></div>
            </div>
            <div class="form_field sho">
              <label>到达站：</label>
              <input id="train_destination" class="field_input clickinput portinput" type="text" autocomplete="off" value="三亚"name="arriveCityName">
    ...
    <div class="hot_line sideblock an_mo" liwithhan="category_热卖线路排行">
      <div class="carouselblock">
        <div class="carouselheader"><a href="http://top.tuniu.com/line/" target="_blank">热卖线路产品排行</a></div>
        <div class="carousel">
          <ul id="hotLineList">
          </ul>
        </div>
    ...
    <div class="theinfo clearfix">
      <div class="imgbox">
        <a class="img" href="/line_detail_{{id}}.html" target="_blank">
          <span class="icon gty-icon"></span>

          <img data-original="{{productImg}}" alt="<{{name}}>{{appendTitle}}" style="display: block;">
        </a>
        <p class="sat">
        ...
        <a class="comments" href="/line_detail_{{id}}.html" target="_blank">5.7万人出游</a>
      ...
      <div class="priceinfo">
			...
			<span class="tnPrice">
			    <i>¥</i><em>{{price}}</em>起			</span>
        <a class="sbtn sbtn-24 sbtn-orange" href="/line_detail_{{id}}.html" target="_blank"><span>预订</span></a>
        <a class="favourite" id="favorite_id_210177819" onclick="clickAddScroll(this,210177819,4);"><div class="tn_fontface"></div>关注</a>
      </div>
    </div>
  </li>
</script>
<script type="text/html" id="tpl-hot-local-item">
  <li class="gallery-list-item fl first ">
    <div class="imgblock">
      <a onclick="_gaq.push(['_trackEvent','列表页','点击','底部_当地玩乐_产品推荐_1'])" title="【途牛专线】<三亚蜈支洲岛纯玩一日游>(海岛观光+上门接送+舒适商务拼车)" href="http://www.tuniu.com/tours/5789336" target="_blank">
        <img src="http://m.tuniucdn.com/fb2/t1/G1/M00/A7/92/Cii9EFaP8uCIP7FlAAC0-sMJnS8AABYXgEFmRYAALUS730_w500_h280_c1_t0_w160_h90_c1_t0.jpg" data-src="http://m.tuniucdn.com/fb2/t1/G1/M00/A7/92/Cii9EFaP8uCIP7FlAAC0-sMJnS8AABYXgEFmRYAALUS730_w500_h280_c1_t0_w160_h90_c1_t0.jpg" style="display: inline;">
      </a>
      <div class="dess_bg"></div>
      <div class="dess">【途牛专线】&lt;三亚蜈支洲岛纯玩一日游&gt;(海岛观光+上门接送+舒适商务拼车)</div>
    </div>
  ...
  <li class="gallery-list-item fl first ">
    ...
    <div class="exter_mess">
      <div class="box p1 clearfix">
        ...
        <div class="comment fr">2165条评论</div>
      </div>
      <div class="box clearfix">
  ...
  <li class="clearfix">
    <div class="pic">
      <a href="/line_detail_{{id}}.html" target="_blank">
        <img style="display: inline;" data-original="{{productImg}}">
      </a>
    </div>
    <div class="des">
      <p class="name"><a href="/line_detail_{{id}}.html" target="_blank">&lt;{{name}}&gt;{{appendTitle}}</a></p>
      <p class="price"><em>¥{{price}}</em>起</p>
    </div>
...
<script type="text/html" id="tpl-interest-history-item">
  <li class="seller_item clearfix">
    <a href="/line_detail_{{resObjectId}}.html" target="_blank">
      <img data-original="{{imgPath}}" style="display: block;">
    </a>
    <a href="/line_detail_{{resObjectId}}.html" target="_blank">
      <h6>&lt;{{title}}&gt;滇楚锁钥 黔东门户</h6>
      <p>{{introduction}}</p>
    </a>
    <p>
       <span class="fl">
