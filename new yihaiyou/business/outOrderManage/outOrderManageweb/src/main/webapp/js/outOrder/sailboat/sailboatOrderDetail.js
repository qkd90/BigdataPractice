...
var SailboatOrderDetail = {
    init: function() {
        SailboatOrderDetail.initTicketType();
    ...
    initJsp: function() {
        ...
        if (refund == "0") {
            ...
            SailboatOrderDetail.ticketStatus();
        }
        ...
        $("#editActualPriceDialog").dialog({
            ...
            buttons:[{
                ...
                handler:function(){
                    ...
                    //SailboatOrderDetail.payOrder(orderId);
                }
            },{
                text:'取消',
                handler:function(){
    ...
    applyCancelDialog: function() {
                            ...
                            function(result) {
                                if (result.success) {
                                    ...
                                    $.messager.confirm('余额不足', '退款余额还需充值：￥'+ money +'，您确定要充值吗？', function(r){
                                        if (r){
                                            SailboatOrderDetail.onpenRechargeDialog(money);
                                        } else {
                                            show_msg("您已取消充值操作！");
                                        }
                                    });
        ...
        SailboatOrderDetail.dgCancelOrder();
    ...
    dgCancelOrder: function() {
        ...
        $('#dg_cancelOrder').datagrid({
            ...
            onLoadSuccess: function() {
                SailboatOrderDetail.mergeGridColCells($(this), "ticketName")
            }
        });
    ...
    initTicketType: function() {
        ...
        $('#dg_ticketType').datagrid({
            ...
            onLoadSuccess: function() {
                SailboatOrderDetail.mergeGridColCells($(this), "ticketName");
                SailboatOrderDetail.mergeGridColCells($(this), "type");
                SailboatOrderDetail.mergeGridColCells($(this), "startTime");
                //SailboatOrderDetail.mergeGridColCells($(this), "useStatus");
                //SailboatOrderDetail.mergeGridColCells($(this), "price");
            }
        });
            ...
            columns:[[
                ...
                {field:'opt',title:'操作',width:'10%',
                    formatter: function(value, rowData, index) {
                        ...
                        var confirmRefund = '<a href="javascript:void(0)" style="color:blue;" onclick="SailboatOrderDetail.confirmRefundOrder('+rowData.id+')">确认退款</a>';
