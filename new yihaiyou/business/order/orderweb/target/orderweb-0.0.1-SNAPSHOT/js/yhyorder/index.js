...
*/
    ...
    initClient_dg: function() {
        ...
        $('#client_dg').datagrid({
            ...
            striped:true,//斑马线
            columns:[[
                {field: 'id', title: '订单ID', width: '100', sortable: true},
                {field: 'orderNo', title: '订单编号', width: '200', sortable: true},

                {field: 'userName', title: '联系人', width: '200', sortable: true},
                {field: 'mobile', title: '联系电话', width: '200', sortable: true},
                //{field: 'orderType', title: '类型', width: '10%', sortable: true,
                ...
                //},
                {
                    field: 'name', title: '预订产品名称', width: '450', sortable: true
                },
                {field: 'createTime', title: '下单时间', width: '200', sortable: true},
                {
                    field: 'status', title: '订单状态', width: '100', sortable: true, formatter: function (value) {
                        if (value == 'WAIT') {
