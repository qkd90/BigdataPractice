package com.data.data.hmly.action.mall.vo;
...
public class MallConfig {
	...
	public String getImguriPreffix() {
		return imguriPreffix;
	}

	public void setImguriPreffix(String imguriPreffix) {
		this.imguriPreffix = imguriPreffix;
	}
}
