...
<script type="text/javascript" src="/js/ticket/ticketPublishSuccess.js"></script>
				...
				<div class="pub">
					<div class="pub_img">
		   			...
		   			<div class="left-block">
		   				<h2 class="hd">门票发布成功！</h2>
		   				<%--<p><b>√</b> 已正常展示分销网</p>--%>
		   				<div class="pub_btn">
		   					<a href="javascript:;" class="easyui-linkbutton" onclick="TicketPublishSuccess.reToList()">返回管理列表</a>
		   					<a href="javascript:;" class="easyui-linkbutton" onclick="TicketPublishSuccess.editTicket()">重新编辑门票</a>
		   					<a href="javascript:;" class="easyui-linkbutton" onclick="TicketPublishSuccess.addNewTicket()">添加新的门票</a>
		   				</div>
		   			</div>
			   	</div>
