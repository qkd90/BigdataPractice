...
<div class="hotelOrder hotelIndex">
    ...
    <div class="body_order">
        ...
        <div class="orderPay clearfix ">
            <div class="payTop">
                <div class="picture"><img src="${QINIU_BUCKET_URL}${scenicInfo.cover}"></div>
                <div class="order_mess">
                    ...
                    <p>
                        ...
                        <span class="roomNum"><label>购买数量：</label>${orderDetail.num}</span>
...
<script type="text/javascript" src="/js/order/ticketOrder_pay.js"></script>
