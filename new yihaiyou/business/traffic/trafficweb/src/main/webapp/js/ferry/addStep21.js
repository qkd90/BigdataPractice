var addStep21 = {
	...
	doEditPrice : function(priceId) {
		var url = "/traffic/ferry/addStep2.jhtml?typePriceId=" + priceId + "&productId=" + $("#productId").val();
		window.location.href = url;	
	},
	// 上一步
	prevGuide:function(){
		var url = "/traffic/ferry/addStep2.jhtml?productId=" + $("#productId").val();
		window.location.href = url;	
	},	
	// 下一步
	nextGuide:function(){
		parent.window.showGuide(3, true, "/traffic/ferry/addStep3.jhtml?productId=" + $("#productId").val());
	}
};
