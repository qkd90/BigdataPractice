...
<div class="easyui-layout" data-options="fit:true">
	...
	<div data-options="region:'south',border:false"
		...
		<a class="easyui-linkbutton"
			href="javascript:void(0)" onclick="submitUserCenterForm()">提交</a>
		<a class="easyui-linkbutton"
			href="javascript:void(0)" onclick="clearUserCenterForm()">重置</a>
		<a class="easyui-linkbutton"
			href="javascript:void(0)" onclick="closeUserCenterForm()">关闭</a>
	</div>
	

	<script type="text/javascript">
	//提交表单
	function submitUserCenterForm() {
	...
	// 重置填入的数据
	function clearUserCenterForm() {
		$('#userInputForm').form('reset');
		
	}
	
	// 关闭窗口
	function closeUserCenterForm(){
		$('#userWindow').window('close');
	}
