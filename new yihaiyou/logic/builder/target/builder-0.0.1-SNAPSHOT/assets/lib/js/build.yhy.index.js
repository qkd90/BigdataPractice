...
$(function () {
    $(".build").click(function () {
        ...
        if (button.hasClass("cruiseshipDetail")) {
            $("#cruiseship-detail").find(".count").text("0");
            var startId = $("#cruiseship-start-id").val();
            var endId = $("#cruiseship-end-id").val();
            $.get(button.attr("data-url"), {startId: startId, endId: endId}, function (result) {
                if (result == "success") {
                    button.removeClass("btn-info").addClass("btn-success").text("build成功").removeClass("disabled");
                } else {
        ...
        if (button.hasClass("recommendPlanDetail")) {
            $("#recommendPlan-detail").find(".count").text("0");
            var startId = $("#recommendPlan-start-id").val();
            var endId = $("#recommendPlan-end-id").val();
            $.get(button.attr("data-url"), {startId: startId, endId: endId}, function (result) {
                if (result == "success") {
                    button.removeClass("btn-info").addClass("btn-success").text("build成功").removeClass("disabled");
                } else {
