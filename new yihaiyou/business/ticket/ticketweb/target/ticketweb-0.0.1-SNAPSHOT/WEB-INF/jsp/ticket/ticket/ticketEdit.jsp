...
<script type="text/javascript" src="/js/ticket/ticketEdit.js"></script>
		...
		<div data-options="region:'center',split:true">
			...
			<form id="userInputForm" name="userInputForm" method="post" style="margin-top: 10px;">
				...
				<div class="row">
					...
					<input type="hidden" id="ticke_type" name="ticket.ticketType" value="scenic"/>
				...
				<div class="row" id="div_jd_name">
					...
					<div id="div1_sce" class="second">
						<input class="easyui-combobox" style="width: 220px" value="" id="scenicNameId"
					...
					<div id="div2_sce" style="display:none;" class="second">
						...
						<a id="btn_editSce" href="javascript:void(0)" class="easyui-linkbutton"
									 onclick="TicketEdit.editScenic()">修改景点</a>
					</div>
...
<!-- 								<option>自定义分类</option> -->
						...
						<div class="accordion_child1">
							...
							<%--<input type="hidden" id="hidden_ruyuan" value='${ticketExplain.enterDesc }'>--%>
								<textarea id="kindRuyuan" name="enterDesc"
									style="width: 700px; height: 200px; visibility: hidden;">${ticketExplain.enterDesc }</textarea>
									
									<a class="use_template" href="javascript:;" id="use_ruyuan">使用模板</a>
									<span class="img_tip_offer">
										最多可输入<em id="em_ruyuan">1000</em>字
									</span>
							</div>
						</div>
						<div class="accordion_child1">
							...
							<%--<input type="hidden" id="hidden_tuigai" value='${ticketExplain.rule}'>--%>
								<textarea id="kindTuigai" name="rule"
									style="width: 700px; height: 200px; visibility: hidden;">${ticketExplain.rule }</textarea>
						...
						<div class="accordion_child1">
							...
							<%--<input type="hidden" id="hidden_privilege" value='${ticketExplain.privilege}'>--%>
...
<!-- 								<input type="button" class="J_add_pic" style="margin-left:5px;" id="add_pictoeditor" onclick="" value="添加图片到详情"> -->
						...
						<div class="accordion_child1" style="display: none;">
							<div class="first">入园保障：</div>
							<div class="second">
								<div id="check_div_id" style="cursor: pointer;width: 320px;height:28px;line-height:28px">
									<input type="hidden" id="hidden_input_agree" name="agreeRuleStr" value="${ticket.agreeRule}">
									<input id="input_agree" type="checkbox" style="height:13px;line-height:16px"> <span id="div_agree">同意加入旅行帮门票入园保障服务</span>
								</div>
