...
var TicketEditOfferList = {
		...
		addTicketPrice:function(){
			...
			url = "/ticket/ticket/ticketEditOffer.jhtml?ticketId="+$("#ticketId").val();
...
//			var param = "?tpId="+id;
			...
			var url = "";
			if(ticketId){
				url = "/ticket/ticket/ticketEditOffer.jhtml?ticketPriceId="+id+"&ticketId="+ticketId;
			}else{
				url = "/ticket/ticket/ticketEditOffer.jhtml?ticketPriceId="+id;
			}
			var ifr = $("#dd").children()[0];
			$(ifr).attr("src", url);
			$('#dd').dialog({    
