...
<head>
    ...
    <script type="text/javascript" src="/js/proManage/quantityUnitListManage.js"></script>
    <title></title>
            ...
            <div id="ticket_tool">
                <div style="padding:2px 5px;">
                    <form action="" id="ticket_form">
                        ...
                        <a href="javascript:void(0)"  class="easyui-linkbutton"  onclick="QuantityUnitPro.doSearchTicket()">查询</a>
                        <a href="javascript:void(0)"  class="easyui-linkbutton"  onclick="QuantityUnitPro.clearTicket()">清空</a>
                    </form>
                </div>
                <%--<div style="padding:2px 5px;">--%>
            ...
            <div id="line_tool">
                <div style="padding:2px 5px;">
                    <form action="" id="consume_form">
                        ...
                        <a href="javascript:void(0)" id="consume_search" class="easyui-linkbutton"  onclick="QuantityUnitPro.doSearcLine()">查询</a>
                        <a href="javascript:void(0)"  class="easyui-linkbutton"  onclick="QuantityUnitPro.clearLine()">清空</a>
                    </form>
                </div>
                <div style="padding:2px 5px;">
