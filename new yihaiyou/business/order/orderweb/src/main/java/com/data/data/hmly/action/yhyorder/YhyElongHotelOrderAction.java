 ...
 */
public class YhyElongHotelOrderAction extends FrameBaseAction {
...
//            rows = order.getOrderDetails().size();
        ...
        return dispatch("/WEB-INF/jsp/yhyorder/elongOrder/elongOrderDetail.jsp");
    }
    ...
    // /yhyorder/yhyElongHotelOrder/elongOrderManage.jhtml
    public Result elongOrderManage() {
        return dispatch("/WEB-INF/jsp/yhyorder/elongOrder/elongOrderIndex.jsp");
    }
