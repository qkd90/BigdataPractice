...
var HotelOrderDetail = {
    init: function() {
        HotelOrderDetail.initTicketType();
        ...
        $("#editActualPriceDialog").dialog({
            ...
            buttons:[{
                ...
                handler:function(){
                    ...
                    //HotelOrderDetail.payOrder(orderId);
                }
            },{
                text:'取消',
                handler:function(){
    ...
    applyCancelDialog: function() {
                            ...
                            function(result) {
                                if (result.success) {
                                    ...
                                    $.messager.confirm('余额不足', '退款余额还需充值：￥'+ money +'，您确定要充值吗？', function(r){
                                        if (r){
                                            HotelOrderDetail.onpenRechargeDialog(money);
                                        } else {
                                            show_msg("您已取消充值操作！");
                                        }
                                    });
        ...
        HotelOrderDetail.dgCancelOrder();
    ...
    dgCancelOrder: function() {
        ...
        $('#dg_cancelOrder').datagrid({
            ...
            onLoadSuccess: function() {
                HotelOrderDetail.mergeGridColCells($(this), "ticketName")
            }
        });
    ...
    initTicketType: function() {
        ...
        $('#dg_ticketType').datagrid({
            ...
            onLoadSuccess: function() {
                HotelOrderDetail.mergeGridColCells($(this), "ticketName");
                HotelOrderDetail.mergeGridColCells($(this), "type");
                HotelOrderDetail.mergeGridColCells($(this), "startTime");
                //HotelOrderDetail.mergeGridColCells($(this), "useStatus");
                //HotelOrderDetail.mergeGridColCells($(this), "price");
            }
        });
            ...
            columns:[[
                ...
                {field:'opt',title:'操作',width:'10%',
                    formatter: function(value, rowData, index) {
                        ...
                        var confirmRefund = '<a href="javascript:void(0)" style="color:blue;" onclick="HotelOrderDetail.confirmRefundOrder('+rowData.id+')">确认退款</a>';
