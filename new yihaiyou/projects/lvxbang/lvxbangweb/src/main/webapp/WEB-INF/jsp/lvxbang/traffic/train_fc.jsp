...
<body myname="mall" class="Order_hc_zz Order_hc_fc">
...
<div class="main cl">
    ...
    <div class="w1225 Order_hc_center" id="nav" style="margin-bottom: 70px">
        <!--左-->
        <div id="loadingLeave" style="margin-top: 9%;">
        ...
        <div id="leave" style="display:none" class="Order_hc_c_fl Order_hc_zz_fl fl">
            <div class="Order_title">
                <b class="ff_yh">去程</b>
                <span>${leaveCityName}->${arriveCityName}</span><span id="span-leaveDate">${leaveDate}</span>（共<span
            ...
            <div class="bot_l">
                ...
                <%--<p class="cl"></p>--%>
                <%--</div>--%>
                <%--<div class="select_div cond_arrive_time" num="6" id="conditions_arriveTime">--%>
                <%--<label>到达时段</label>--%>
                <%--<ul class="fore sel">--%>
                <%--<li><a title="不限" href="javaScript:;" class="checked">不限</a></li>--%>
                <%--<li><a title="" href="javaScript:;">6-12点</a></li>--%>
                ...
                <div class="Order_hc_list">
                    <div class="Order_hc_list_t">
                        ...
                        <%--<div class="w6 fl" style="width: 60px;">--%>
                            <%--余票--%>
                        <%--</div>--%>
                        <div id="fc-left" class="w7 fr" style="width: 70px;">
                            <label class="fl checkbox posiR disB" input="options"><i
                                    onclick="selectTicket('fc-left', 'Order_hc_list_ul')"></i></label>
        ...
        <!--右-->
        <div id="loadingReturn" class="Order_hc_c_fl Order_hc_zz_fr fr" style=" margin-top:9%;color:#666;">
            <img align="absmiddle" src="/images/loadingx.gif">
            <p class="mt10">
                正在为您加载车次信息...
            </p>
        ...
        <div id="return" style="display:none" class="Order_hc_c_fl Order_hc_zz_fr fr">
            <div class="Order_title">
                <b class="ff_yh">返程</b>
                <span>${arriveCityName}->${leaveCityName}</span><span id="span-returnDate">${returnDate}</span>（共<span
                ...
                <div class="Order_hc_list">
                    <div class="Order_hc_list_t">
                        ...
                        <%--<div class="w6 fl" style="width: 60px;">--%>
                            <%--余票--%>
                        <%--</div>--%>
                        <div id="fc-right" class="w7 fr" style="width: 70px;">
                            <label class="fl checkbox posiR disB" input="options"><i
                                    onclick="selectTicket('fc-right', 'Order_hc_list_ul_back')"></i></label>
                            <p class="fl" style="width: 50px;">仅有票</p>
                        </div>
                    </div>
                    <div class="Order_hc_list_div">
...
<script src="/js/lvxbang/traffic/train_fc.js" type="text/javascript"></script>
