...
<div class="hotelIndex">
    ...
    <div class="directories">
        <div class="rangestate">
            您在这里：<a href="/yhypc/index/index.jhtml">首页</a> &gt; <a href="/yhypc/scenic/index.jhtml">景点门票</a> &gt; 厦门景点
        </div>
        <div class="dirbox">
            <input type="hidden" id="labelId" value="<c:out escapeXml='true' value='${labelId}'/>">
            <input type="hidden" id="cityId" value="<c:out escapeXml='true' value='${cityId}'/>">
            <div class="dirbody">
                <div class="position keyword clearfix">
                    <label>关键字：</label>
                    <ul class="clearfix">
                        <li>
                            <input class="word" type="text" id="searchWord" placeholder="关键字" value="<c:out escapeXml='true' value='${searchWord}'/>">
...
<script type="text/javascript" src="/js/scenic/scenicList.js"></script>
    ...
    <div class="list_body">
        <div class="body_detail clearfix">
            ...
            <div class="body_describ clearfix">
                <div class="address">
                    <a target="_blank" href="/scenic_detail_{{id}}.html">
                ...
                {{if price <= 0}}<div class="price_count" style="visibility: hidden">{{else}}<div class="price_count">{{/if}}
                    ...
                    <div class="tackdetail"><a target="_blank" href="/scenic_detail_{{id}}.html">查看详情</a></div>
                </div>
            </div>
        </div>
    </div>
