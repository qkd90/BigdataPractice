...
public class GenBillNo {
    public static final Integer INIT_LIMIT_NO = 1000;    // 初始最大值限制，超过时订单位数会增加
...
//    }
    ...
    /**
     * 规则说明：9位时间戳+3位唯一编号（位数可变）
     * 使用范围：满足32年（2049年后）内单号在千/秒以下（超过该量级位数会相应增加）的12位订单编号
     * @return
     */
