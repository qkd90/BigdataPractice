 ...
 */
var CheckClientLineDetail = {
    init: function() {
        CheckClientLineDetail.initTicketType();

        CheckClientLineDetail.initJsp();
    },
    ...
    initJsp: function() {
        ...
        if (refund == "0") {
            ...
            CheckClientLineDetail.ticketStatus();
        }
        ...
        $("#editActualPriceDialog").dialog({
            ...
            buttons:[{
                ...
                handler:function(){
                    ...
                    //CheckClientLineDetail.payOrder(orderId);
                }
            },{
                text:'取消',
                handler:function(){
    ...
    applyCancelDialog: function() {
                            ...
                            function(result) {
                                if (result.success) {
                                    ...
                                    $.messager.confirm('余额不足', '退款余额还需充值：￥'+ money +'，您确定要充值吗？', function(r){
                                        if (r){
                                            CheckClientLineDetail.onpenRechargeDialog(money);
                                        } else {
                                            show_msg("您已取消充值操作！");
                                        }
                                    });
        ...
        CheckClientLineDetail.dgCancelOrder();
    ...
    dgCancelOrder: function() {
        ...
        $('#dg_cancelOrder').datagrid({
            ...
            onLoadSuccess: function() {
                CheckClientLineDetail.mergeGridColCells($(this), "ticketName")
            }
        });
    ...
    initTicketType: function() {
        ...
        $('#dg_ticketType').datagrid({
            ...
            columns:[[
                ...
                {field:'startTime',title:'出发日期',width:'15%',
                    formatter: function(value, rowData, index) {
            ...
            onLoadSuccess: function() {
                CheckClientLineDetail.mergeGridColCells($(this), "ticketName");
                CheckClientLineDetail.mergeGridColCells($(this), "type");
                CheckClientLineDetail.mergeGridColCells($(this), "startTime");
                //CheckClientLineDetail.mergeGridColCells($(this), "useStatus");
                //CheckClientLineDetail.mergeGridColCells($(this), "price");
            }
        });
            ...
            columns:[[
                ...
                {field:'opt',title:'操作',width:'10%',
                    formatter: function(value, rowData, index) {
                        ...
                        var confirmRefund = '<a href="javascript:void(0)" style="color:blue;" onclick="CheckClientLineDetail.confirmRefundOrder('+rowData.id+')">确认退款</a>';
