...
//        $('#qry_city').combobox('select', null);
    ...
    // 新增
    function add() {
        window.parent.addTab('新增景点', "/scenic/scenicInfo/add.jhtml");
    }
    // 审核
    function audit(id) {
        window.parent.addTab('审核景点', "${ctxPath}/mgrer/scenic/audit?id=" + id);
    }
    // 修改
    function edit(id) {
//        alert(id);
