...
var TicketConstants = {
	...
	ticketPriceStatus: [{id: 'UP_CHECKING', text: '上架中'}, {id: 'UP', text: '已上架'}, {id: 'REFUSE', text: '被拒绝'}, {id: 'DOWN', text: '已下架'}],
	// 状态
	ticketStatus : [{'id':'','text':'门票状态','filter':true},{'id':'UP','text':'上架'},{'id':'DOWN','text':'下架'},{'id':'CHECKING','text':'待审核'},{'id':'FAIL','text':'审核不通过'}],
	ticketType: [{'id':'sailboat','text':'帆船'}, {'id':'yacht','text':'游艇'}, {'id': 'huanguyou', text:'鹭岛游'}],
	booleanType: [{'id':true,'text':'是'}, {'id':false,'text':'否'}],
...
var TicketUtil = {
	...
	// build游艇帆船，重新生成静态页面
	buildSailboat : function(id) {
		if (FG_DOMAIN) {	// 有配置则执行
			$.post(FG_DOMAIN + '/build/yhy/buildOneSailboat.jhtml', {id: id},
				function (data) {
				}
			);
		}
