 ...
 */
@Service
public class FerryMobileService {
    @Resource
    ...
    public Map<String, String> optimizeLine = Maps.newHashMap();
    ...
    public Map<String, Object> getOptimizeDailyFlight(String date) {
        try {
            ...
            if ("0".equals(resultMap.get("code").toString())) {
                List<Map<String, Object>> flightList = FerryUtil.castList((((Map) resultMap.get("content")).get("list")));
    ...
    public Member completeUserFerryMember(Member user, FerryMember ferryMember) {
        FerryMember member = user.getFerryMember();
        member.setTrueName(ferryMember.getTrueName());
        member.setIdnumber(ferryMember.getIdnumber());
        member.setMobile(ferryMember.getMobile());
        member.setBankNo(ferryMember.getBankNo());
        user.setFerryMember(member);
        return user;
    }
