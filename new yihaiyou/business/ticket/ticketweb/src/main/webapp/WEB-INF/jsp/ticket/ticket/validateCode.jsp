...
<script type="text/javascript" src="/js/ticket/validateUtil.js"></script>
<script type="text/javascript" src="/js/scemanager/easy_excel.js"></script>
<script type="text/javascript" src="/js/ticket/validatecode.js"></script>
	<style type="text/css">
		.calender_class {
	...
	<div class="easyui-layout" data-options="fit:true"
         style="width:100%;height:100%;">
			...
			<div id="tb" style="padding: 10px;">
				<input id="vcType" type="hidden" value="${vcType}">
				<form action="" id="searchform">
					<div style="float: left;margin-right: 15px;">
						<input class="easyui-textbox"  id="ticNameid" style="width:250px;" data-options="prompt:'产品名称'" >
