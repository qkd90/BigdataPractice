...
cell.css("text-align",(col.halign||"center"));  /*20170118表头默认对齐方式居中*/
...
if(col){
/*var _73f=_73c[_73e]; caiys20151013 support child field, e.g:field.childfield*/
var _73f=_73c[_73e];	
try{
	_73f = eval("_73c['" + _73e.replace(/\./g, "']['") + "']");
} catch(err){
}
/*end caiys20151013*/
