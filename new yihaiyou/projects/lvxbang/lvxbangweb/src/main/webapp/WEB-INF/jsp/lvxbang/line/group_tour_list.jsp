...
<head>
  ...
  <title>${city.name}跟团游_${city.name}周边跟团_国内跟团-旅行帮</title>
  <meta name="keywords" content="${city.name}跟团游,${city.name}周边跟团,国内跟团"/>
  <meta name="description" content="旅行帮提供丰富、优质的${city.name}跟团旅游线路及报价，并搭配多种玩法推荐。${city.name}跟团游来旅行帮！"/>
...
<body myname="groupTourList" class="lines_List index1000">
