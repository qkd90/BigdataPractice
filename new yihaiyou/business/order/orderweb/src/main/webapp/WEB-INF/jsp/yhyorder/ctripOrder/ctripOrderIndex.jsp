...
<head>
    ...
    <script type="text/javascript" src="/js/order/ctripOrder/ctripOrderIndex.js"></script>
    <title>携程OTA门票订单管理</title>
    <style>
        .labelClass {
            float: left;
            margin-right: 5px;
...
<body style="background-color: white">
    ...
    <div title="" class="easyui-layout" data-options="fit:true,border:false" style="width:100%;height:100%;">
        <input type="hidden" id="orderType" value="hotel">
        <!-- 表格工具条 始 -->
        <div id="client_tool">
            <form action="" id=client_form">
                <div style="padding:5px 5px 3px 5px;">
                    ...
                    <input id="client_recName" class="easyui-textbox" data-options="prompt:'取票人'" style="width:150px;">
                    <input id="client_mobile" class="easyui-textbox" data-options="prompt:'取票人电话'" style="width:150px;">
                    <input id="client_status" class="easyui-combobox" data-options="prompt:'订单状态',editable:false,
                        valueField: 'id',
                        textField: 'value',
                        panelHeight: 'auto',
                         data:　CtripOrderManage.orderStatus
                        " style="width:150px;">
                    ...
                    <a href="javascript:void(0)" id="client_ship_search" class="easyui-linkbutton"  onclick="CtripOrderManage.doSearch()">查询</a>
                    <a href="javascript:void(0)" id="client_ship_clear" class="easyui-linkbutton"  onclick="CtripOrderManage.clearForm()">重置</a>
                </div>
...
<div id="confirmDialog" class="easyui-dialog" title="订单确认"
     data-options="resizable:false,modal:true,closed:true" style="padding: 10px;top:25%; left: 35%;">
    <div style="height: 100%; width: 100%;">
        <table id="confirmOrder_dg" style="height: 100%; width: 100%;"></table>
    </div>
</div>
