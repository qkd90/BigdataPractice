...
import com.data.data.hmly.action.mobile.response.ScenicResponse;
import com.data.data.hmly.action.mobile.response.ScenicSimpleResponse;
 ...
 */
public class ScenicWebAction extends MobileBaseAction {
    @Resource
