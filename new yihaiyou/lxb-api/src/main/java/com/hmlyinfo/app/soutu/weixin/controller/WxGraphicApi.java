...
import com.hmlyinfo.app.soutu.weixin.service.WxGraphicService;
import com.hmlyinfo.base.ActionResult;
import com.hmlyinfo.base.util.HttpUtil;
import com.hmlyinfo.base.util.Validate;

@Controller
@RequestMapping("/api/pub/wx/graphic")
public class WxGraphicApi
{
	@Autowired
	private WxGraphicService service;
	 ...
	 */
	@RequestMapping("/add")
	public @ResponseBody ActionResult add(final HttpServletRequest request, final WxGraphic domain)
	{
		service.edit(domain);
	 ...
	 */
	@RequestMapping("/edit")
	public @ResponseBody ActionResult edit(final HttpServletRequest request, final WxGraphic domain)
	{
