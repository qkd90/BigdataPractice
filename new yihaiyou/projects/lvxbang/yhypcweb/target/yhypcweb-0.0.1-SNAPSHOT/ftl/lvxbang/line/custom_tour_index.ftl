<div class="bodybg">
    ...
    <#if ctiTopLeftLogoAd??>
        <img width="320" style="float: left;"
             data-original="/static${ctiTopLeftLogoAd.imgPath}" alt="${ctiTopLeftLogoAd.adTitle}"/>
    <#else>
        <img width="320" style="float: left;" data-original="/images/dingzhiyou.jpg"/>
    </#if>
    <#--自助游首页顶部左侧图片 start-->
                ...
                <div class="navi">
                    ...
                    <#list topNavLabelList as topLabel>
                        <li>
                            ...
                            <#list ctiTopNavData[topLabel.name + "_fst_area"] as fstArea>
                                <a href="/self_tour_${fstArea.cityCode}.html" target="_blank">${fstArea.name}</a>
                            </#list>
                            <#if ctiTopNavData[topLabel.name + "_snd_label"]?size &gt; 0>
                                <div class="outer outer${topLabel_index + 1}">
                                    <div class="outerbox">
                                        <#list ctiTopNavData[topLabel.name + "_snd_label"] as sndLabel>
                                            <dl class="clearfix">
                                                <dd><span>${sndLabel.alias}：</span></dd>
                                                <dt>
                                                    <#list ctiTopNavData[sndLabel.name + "_trd_area"] as trdArea>
...
<#-- 各个主版块 start-->
    <div class="main cl">
        <div class="w1000">
            <div id="group_1727" class="horizontal zhutizijia clearfix"><h2>家庭亲子</h2>
                <ul class="clearfix mytab">
                <#list ctiMainQinziLabelList as label>
                ...
                <#list ctiMainQinziLabelList as label>
                    <div id="block_1113980" class="linebox an_mo <#if label_index == 0>now</#if>">
                        <div id="block" class="block clearfix"><!-- paihangModule phMleft start -->
                            <div class="guanzhu">
                                <#list ctiQinziData[label.name + "_area"] as area>
                            ...
                            <#list ctiQinziData[label.name + "_line"] as line>
                                <div class="item">
                                    <div class="pic">
                                    ...
                                    <div class="name">
                                        <a href="/line_detail_${line.id}.html" target="_blank"
                                           title="${line.appendTitle}">&lt;${line.appendTitle}&gt;${line.name}</a>
                                    </div>
                                </div>
                            </#list>
                            <!-- proRecomModule prdMblack end --><!-- txtModule txtMself start -->
                            <a href="/lvxbang/line/ctiMore.jhtml?w=${label.alias}" target="_blank" class="more">查看更多&gt;</a>
                            <!-- txtModule txtMself end -->
                        </div>
                    </div>
                </#list>
            ...
            <div id="group_1727" class="horizontal zhutizijia clearfix"><h2>蜜月摄影</h2>
                <ul class="clearfix mytab">
                <#list ctiMainMiyueLabelList as label>
                    <li id="block_l${label.id}" class="<#if label_index == 0>on</#if>"><a href="javascript:void(0)" rel="nofollow">${label.alias}</a></li>
                </#list>
                </ul>
                <div id="tabs" class="line-con">
                <#list ctiMainMiyueLabelList as label>
                    <div id="block_1113980" class="linebox an_mo <#if label_index == 0>now</#if>">
                        <div id="block" class="block clearfix"><!-- paihangModule phMleft start -->
                            <div class="guanzhu">
                                <#list ctiMiyueData[label.name + "_area"] as area>
                                    <a href="/self_tour_${area.cityCode}.html" target="_blank">
                                        <dl>
                            ...
                            <!-- adModule adMleftad2 end --><!-- proRecomModule prdMblack start -->
                            <#list ctiMiyueData[label.name + "_line"] as line>
                                <div class="item">
                                    <div class="pic">
                                        <a href="/line_detail_${line.id}.html" target="_blank">
                                            <#if line.cover?starts_with("http://")>
        ...
        <#--<ul class="clearfix mytab">-->
        <#--<#list ctiMainChujingLabelList as label>-->
        <#--<li id="block_l${label.id}" class="<#if label_index == 0>on</#if>"><a href="javascript:void(0)" rel="nofollow">${label.alias}</a></li>-->
        <#--</#list>-->
        <#--</ul>-->
        <#--<div id="tabs" class="line-con">-->
        ...
        <#--<div class="guanzhu">-->
        <#--<#list ctiChujingData[label.name + "_area"] as area>-->
        <#--<a href="/self_tour_${area.cityCode}.html" target="_blank">-->
        <#--<dl><dd title="${area.fullPath}">${area.name}</dd>-->
        <#--<dt><i class="tn_fontface"></i></dt></dl>-->
        <#--</a>-->
        ...
        <#--<#list ctiChujingData[label.name + "_line"] as line>-->
        <#--<div class="item">-->
        <#--<div class="pic">-->
        <#--<a href="/line_detail_${line.id}.html" target="_blank">-->
        <#--<#if line.cover?starts_with("http://")>-->
                ...
                <#list rexiaoLine as line>
                    <#if line_index &lt; 3>
                        <div class="item_">
                            ...
                            <span class="myd">满意度：<em>96%</em></span>
                            </div>
                            <div class="name">
                                <a href="/line_detail_${line.id}.html" target="_blank"
