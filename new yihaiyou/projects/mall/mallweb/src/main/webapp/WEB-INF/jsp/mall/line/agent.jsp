    ...
    <div class="row">
      <div class="box sqfenxiao">
        <form class="form-horizontal">
        	<input id="productId" type="hidden" value="<s:property value="lineDisplay.id"/>">
          <div class="form-group">
            <label class="col-xs-2 control-label">产品名称：</label>
            <div class="col-xs-7">
              <p class="form-control-static"><input id="lineName" type="text" class="form-control"  value="<s:property value="lineDisplay.name"/>" maxlength="150"></p>
	          ...
	          <div class="info-price-list text-center clearfix">
	          	<table class="table table-striped table-hover table-bordered">
		            ...
		            <tr>
		                ...
		                <th style="text-align: center">成人价</th>
          ...
          <div class="form-group">
            ...
            <div class="col-xs-8"><label class="radio-inline">
			  <input type="radio" name="lineStatus" value="<s:property value="@com.data.data.hmly.service.line.entity.enums.LineStatus@hide"/>" checked> 放到采购线路仓库，编辑后发布（推荐）
			</label>
			<label class="radio-inline">
			  <input type="radio" name="lineStatus" value="<s:property value="@com.data.data.hmly.service.line.entity.enums.LineStatus@show"/>"> 直接发布
			</label>
            </div>
          </div>
          <div class="form-group">
            <div class="col-xs-10 col-xs-offset-2">
              <p class="form-control-static"><input class="btn btn-warning" type="button" value="确定" onclick="lineAgent.doAgent()"><input class="btn btn-primary" type="button" value="返回"  onclick="lineAgent.doBack()"></p>
            </div>
          </div>
        </form>
      </div>
...
<div class="modal fade ok" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
  <div class="modal-dialog">
    ...
    <div class="md-qd text-center"><a href="javascript:void(0)" onclick="lineAgent.doOk()" data-dismiss="modal" class="btn btn-primary">确定</a></div>
    </dl>
  </div>
</div>
<!--反馈成功弹窗--> 	
...
<script src="${mallConfig.resourcePath}/js/mall/line/lineAgent.js?v=${mallConfig.resourceVersion}"></script>