...
<body style="background-color: white">
    ...
    <div title="" class="easyui-layout" data-options="fit:true,border:false" style="width:100%;height:100%;">
        <input type="hidden" id="orderType" value="cruiseship">
        <!-- 表格工具条 始 -->
        <div id="client_tool">
            <form action="" id=client_form">
                <div style="padding:5px 5px 3px 5px;">
                    ...
                    <input id="client_status" class="easyui-combobox" data-options="prompt:'订单状态',editable:false,
                        ...
                        textField: 'value',
                        panelHeight: 'auto',
                         data:　ClientOrderManage.cruishipOrderStatus
                        " style="width:150px;">
                    ...
                    <a href="javascript:void(0)" id="client_ship_clear" class="easyui-linkbutton"  onclick="ClientOrderManage.clearForm()">清空</a>
                </div>
