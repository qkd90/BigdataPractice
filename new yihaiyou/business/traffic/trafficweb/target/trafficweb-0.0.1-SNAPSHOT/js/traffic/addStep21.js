var addStep21 = {
			...
			columns: [[
				...
				{ field: 'opt', title: '操作', width: 100, align: 'center',
					formatter : function(value, rowData, rowIndex) {
						var btnView = "<a href='javascript:void(0)' style='color:blue;text-decoration: underline;' onclick='addStep21.doEditPrice(" + rowData.id+")'>详情</a>";
						var btnDel = "<a href='javascript:void(0)' style='color:blue;text-decoration: underline;' onclick='addStep21.delPrice("+rowData.id+")'>删除</a>";
	...
	doEditPrice : function(priceId) {
		var url = "/traffic/traffic/addStep2.jhtml?typePriceId=" + priceId + "&productId=" + $("#productId").val();
		window.location.href = url;	
	},
	// 上一步
	prevGuide:function(){
		var url = "/traffic/traffic/addStep2.jhtml?productId=" + $("#productId").val();
		window.location.href = url;	
	},	
	// 下一步
	nextGuide:function(){
		parent.window.showGuide(3, true, "/traffic/traffic/addStep3.jhtml?productId=" + $("#productId").val());
	}
};
