...
<div class="row_hd">
    ...
    <div style="width: 10%;float: left;color: #0092DC"><span>充值成功</span></div>
</div>

<div style="padding: 20px">
    <h2 style="font-size: x-large;">充值成功</h2>
</div>
...
<div class="div_config_btn">
    ...
    <a id="btn2" href="#" class="easyui-linkbutton" onclick="PaySuccess.toCreateOrder()" >继续充值</a>
</div>
</body>
</html>
