var addStep21 = {
			...
			columns: [[
				...
				{ field: 'opt', title: '操作',  width: "33%", align: 'center',
					formatter : function(value, rowData, rowIndex) {
						var btnView = "<a href='javascript:void(0)' style='color:blue;text-decoration: underline;' onclick='addStep21.doEditPrice(" + rowData.id+")'>编辑</a>";
	...
	doEditPrice : function(priceId) {
		var url = "/hotel/hotel/addStep2.jhtml?typePriceId=" + priceId;
	...
	// 下一步
	nextGuide:function(){
		parent.window.showGuide(3, true, "/hotel/hotel/addStep3.jhtml?productId=" + $("#productId").val());
	}
};
