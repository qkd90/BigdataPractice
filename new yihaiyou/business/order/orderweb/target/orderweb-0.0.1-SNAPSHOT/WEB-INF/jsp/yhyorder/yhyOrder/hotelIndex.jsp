...
<head>
    ...
    <script type="text/javascript" src="/js/yhyorder/hotel/index.js"></script>
    <title>酒店订单管理</title>
    <style>
        .labelClass {
            float: left;
        ...
        <div id="client_tool">
            <form action="" id=client_form">
                <div style="padding:5px 5px 3px 5px;">
                    <input id="client_companyId" style="width:200px;"/>
                    <input id="client_orderNo" class="easyui-textbox" data-options="prompt:'订单编号'" style="width:160px;"/>
                    <%--<input id="client_recName" class="easyui-textbox" data-options="prompt:'联系人'" style="width:150px;">--%>
                    <input id="client_mobile" class="easyui-textbox" data-options="prompt:'联系电话'" style="width:140px;">
