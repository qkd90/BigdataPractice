...
<script type="text/javascript" src="/js/sailboat/ticketEditOfferList.js"></script>
...
.text {
		...
		<div data-options="region:'center',split:true" style="height:1000px;">
			...
			<form id="userInputForm" name="userInputForm" method="post" action="">
				...
				<div class="row">
					...
					<div class="second">
						<table id="qryResult" style="width:860px;height:300px"></table>
					</div>
				</div>
				<div class="row">
					<div class="first_offer">
					...
					<input type="hidden" id="hidden_payway" value="${ticket.payway}">
						<select class="easyui-combobox" id="sel_payway" name="payway" style="width: 150px;
						line-height: 22px; border: 1px solid #95B8E7" data-options="
							   prompt:'支付方式',
							   editable:false,
							   valueField: 'id',
							   textField: 'value',
	...
	<div id="dd" class="easyui-dialog" title="修改分类" style="left:0px;top:10px;width:900px;height:100%;"
