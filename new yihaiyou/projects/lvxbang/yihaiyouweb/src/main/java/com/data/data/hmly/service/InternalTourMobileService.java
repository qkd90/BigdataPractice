 ...
 */
@Service
public class InternalTourMobileService {
    ...
    public Map<String, Object> getItiData() {
        Map<String, Object> result = new HashMap<String, Object>();
        List<Ads> topBannerAds = advertisingService.getMobileItiBanner();
        List<Line> tuijianLines = lineService.getLineIndexLine("国内游首页-精品推荐", new Page(1, 2));
        List<TbArea> remenAreas = areaService.getLineIndexArea("国内游首页-热门目的地", new Page(1, 12));
