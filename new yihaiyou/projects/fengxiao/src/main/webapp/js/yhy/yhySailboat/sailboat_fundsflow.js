 ...
 */
var SailboatFundsFlow = {
    fundFlowTable: null,
    init: function() {
        SailboatFundsFlow.initPageComm();
        SailboatFundsFlow.initPageData();
        SailboatFundsFlow.initFundFlowListTable();
    },
    ...
    initFundFlowListTable: function() {
        ...
        SailboatFundsFlow.fundFlowTable = $(".table-striped").DataTable( {
            "serverSide": true,
            "searching": false,
            "ordering": false,
    ...
    search: function() {
        SailboatFundsFlow.fundFlowTable.ajax.reload();
    },
