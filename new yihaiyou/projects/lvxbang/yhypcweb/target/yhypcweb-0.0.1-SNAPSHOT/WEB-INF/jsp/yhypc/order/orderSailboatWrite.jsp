        ...
        <div class="fill-order-body">
            ...
            <div class="fill-order-content">
                ...
                <div class="customer-name">
                    <h5>选择出行游客<a onclick="SailboatOrderWrite.addTourist()">添加游客></a></h5>
...
<script type="text/html" id="tpl-order-sailboat-wirte-customer">
    <div class="checkbox-group clearfix">
        <label onclick="SailboatOrderWrite.statisticOrder()">
...
<script src="/js/order/sailboatOrder_write.js"></script>
</html>