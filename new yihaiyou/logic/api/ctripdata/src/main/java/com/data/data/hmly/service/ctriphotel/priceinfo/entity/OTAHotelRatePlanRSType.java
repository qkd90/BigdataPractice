...
/**
 * <p>OTA_HotelRatePlanRSType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="OTA_HotelRatePlanRSType">
 *   &lt;complexContent>
...
@XmlType(name = "OTA_HotelRatePlanRSType", propOrder = {
    "ratePlans",
    "success"
})
public class OTAHotelRatePlanRSType {

    @XmlElement(name = "RatePlans")
    protected List<RatePlansType> ratePlans;
...
//    }
    ...
    public List<RatePlansType> getRatePlans() {
        return ratePlans;
    }

    public void setRatePlans(List<RatePlansType> ratePlans) {
