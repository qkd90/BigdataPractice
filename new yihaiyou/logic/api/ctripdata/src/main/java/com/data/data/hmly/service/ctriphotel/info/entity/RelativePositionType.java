 ...
 *               &lt;enumeration value="驾车约1.376公里(约5分钟)"/>
 *               &lt;enumeration value="驾车约88.526公里(约114分钟)"/>
 *               &lt;enumeration value="驾车约53.693公里(约77分钟)"/>
 *               &lt;enumeration value="驾车约84.772公里(约90分钟)"/>
 *               &lt;enumeration value="驾车约87.576公里(约81分钟)"/>
 *               &lt;enumeration value="驾车约78.535公里(约77分钟)"/>
 *             &lt;/restriction>
 *           &lt;/simpleType>
 *         &lt;/element>
 *       &lt;/sequence>
...
@XmlType(name = "RelativePositionType", propOrder = {
    "content"
})
public class RelativePositionType {

    @XmlElementRef(name = "DescriptiveText", type = JAXBElement.class, required = false)
    @XmlMixed
