...
<head>
    ...
    <script type="text/javascript" src="/js/line/line/quantitySalesDialog.js"></script>
...
<div style="padding: 15px;">
    <form id="quantity_form_id">
        <input type="hidden" id="hpt_ticketId" name="typePriceId" value="${linetypeprice.id}">
        ...
        <div style="font-size: 16px;font-weight: 700; margin-bottom: 10px;">
            <label>产品名称：</label>
            <label>${linetypeprice.line.name}</label>
        </div>
        <div style="font-size: 16px;font-weight: 700; margin-bottom: 10px;">
            <label>票种类型：</label>
            <label>${linetypeprice.quoteName}</label>
        </div>
        <div style="font-size: 16px;font-weight: 700; margin-bottom: 10px;">
            <label>拱量对象：</label>
        ...
        <div>
            <div id="q_center" style="width: 440px;height: 190px;">
...
<div style="width: 100%; height: 30px; position: absolute; bottom: 0px;">
    <div style="float:right;">
        <a href="javascript:void(0)" style="width: 100px;"  class="easyui-linkbutton"  onclick="LineQuantitySales.saveQuantitySales()">保存</a>
        <a href="javascript:void(0)" style="width: 100px;"  class="easyui-linkbutton"  onclick="LineQuantitySales.cancelQuantitySales()">关闭</a>
    </div>
</div>

<div id="quantity_dialog" class="easyui-dialog"
     data-options="closed:true," style="left:0px;top:10px;width: 450px; height: 300px;">
