...
<script type="text/javascript" src="/js/ticket/ticketEditOffer.js"></script>
...
<%-- 				<input id="isAgent" type="hidden" name="" value="${agent}"/> --%>
				...
				<div class="row">
					...
					<div class="second" id="div_kindYuding">
						<textarea id="kindYuding" name="orderKnow" 
							style="width: 700px; height: 200px; visibility: hidden;">${ticketPrice.orderKnow}</textarea>
						<input id="dateSourceId" name="dataJson" type="hidden" value=''/>
					</div>
					<div class="second" id="div_kindYuding">
						
						<a class="use_template" href="javascript:;" id="useTemplate">使用模板</a>
...
<%-- 		                        <input class="easyui-numberbox" id="input_childPrice" name="childPrice" value="${ticketPrice.childPrice}" style="width:80px;" data-options="min:0,precision:2"> --%>
		                        <input class="easyui-numberbox" id="discountPrice" value="" style="width:80px;" data-options="min:0,precision:2">
		                        <span>结算价：</span>
		                        <font color="red"></font>
		                        <input class="easyui-numberbox" id="commissionPrice" value="" style="width:80px;" data-options="min:0,precision:2">
								 <span>市场价：</span>
								 <font color="red"></font>
								 <input class="easyui-numberbox" id="marketPrice" value="" style="width:80px;" data-options="min:0,precision:2">
								 <span>库存：</span>
								 <font color="red">*</font>
								 <%-- 		                        <input class="easyui-numberbox" id="input_childPrice" name="childPrice" value="${ticketPrice.childPrice}" style="width:80px;" data-options="min:0,precision:2"> --%>
