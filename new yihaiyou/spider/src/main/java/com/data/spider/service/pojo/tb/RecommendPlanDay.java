 ...
 */
@Entity
@javax.persistence.Table(name = "recommend_plan_day")
public class RecommendPlanDay extends com.framework.hibernate.util.Entity {
    private long id;
    ...
    @Basic
    @javax.persistence.Column(name = "day", nullable = true)
    public Short getDay() {
        return day;
    }
    ...
    @Basic
    @javax.persistence.Column(name = "hours", nullable = true)
    ...
    @Basic
    @javax.persistence.Column(name = "citys", nullable = true, length = 255)
    ...
    @Basic
    @javax.persistence.Column(name = "hotel", nullable = true, length = 255)
    ...
    @Basic
    @javax.persistence.Column(name = "food", nullable = true, length = 255)
    ...
    @Basic
    @javax.persistence.Column(name = "traffic_cost", nullable = true, precision = 2)
    ...
    @Basic
    @javax.persistence.Column(name = "traffic_time", nullable = true)
    ...
    @Basic
    @javax.persistence.Column(name = "isLast", nullable = true, length = 255)
    ...
    public boolean equals(Object o) {
        ...
        RecommendPlanDay that = (RecommendPlanDay) o;
