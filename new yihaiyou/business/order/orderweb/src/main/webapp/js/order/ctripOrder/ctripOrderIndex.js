...
var CtripOrderManage = {
    ...
    init: function() {
        CtripOrderManage.initCtripOrderManage_dg();
    },
    initCtripOrderManage_dg: function() {
        var url = "/yhyorder/yhyCtripTicketOrder/getOrderList.jhtml";
        $('#client_dg').datagrid({
            url:url,
            fit:true,
            pagination:true,
            ...
            columns:[[
                ...
                {field: 'userName', title: '取票人', width: '200'},
                {field: 'mobile', title: '取票人电话', width: '200'},
                {
                    field: 'name', title: '预订产品名称', width: '550'
                },
                {field: 'price', title: '订单金额', width: '200', align: 'center'},
                {field: 'createTime', title: '下单时间', width: '150'},
                {
                    field: 'status', title: '订单状态', width: '150', formatter: function (value) {
                    if (value == 'WAIT') {
                ...
                },
                {
                    ...
                    var btn =  '<a href="#" style="color:blue;" onclick="CtripOrderManage.openDetail(' + rowData.id + ',' + index + ')" class="easyui-linkbutton" >详情</a>';
                    var returnBtn = btn;
                    return returnBtn;
                }
                }
            ...
            onBeforeLoad: function(data) {
                data['order.orderType'] = 'ticket';
                data['order.thirdOrderSources[0]'] = 'CTRIP';
    ...
    openDetail: function(id) {
        ...
        var url = "/yhyorder/yhyCtripTicketOrder/orderDetail.jhtml?orderId="+id;
        $(ifr).attr("src", url);
