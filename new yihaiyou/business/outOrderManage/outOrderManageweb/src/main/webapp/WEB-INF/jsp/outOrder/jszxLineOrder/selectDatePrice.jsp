...
<head>
    ...
    <script type="text/javascript" src="/js/outOrder/lineOrder/selectDatePrice.js"></script>
</head>
<style type="text/css">
  body {
    font-size: 14px;
...
<body>
    <input type="hidden" id="ticketPriceId" value="${typePriceId}">
    <input type="hidden" id="ticketIndex" value="${index}">
    <input type="hidden" id="priceType" value="${type}">
