package com.hmlyinfo.app.soutu.pay.ali.direct.mobile;
...
import com.hmlyinfo.app.soutu.pay.ali.util.MD5;
import com.hmlyinfo.app.soutu.pay.ali.util.RSA;
import com.hmlyinfo.app.soutu.pay.ali.util.httpclient.HttpProtocolHandler;
import com.hmlyinfo.app.soutu.pay.ali.util.httpclient.HttpRequest;
import com.hmlyinfo.app.soutu.pay.ali.util.httpclient.HttpResponse;
import com.hmlyinfo.app.soutu.pay.ali.util.httpclient.HttpResultType;
...
public class AlipaySubmit {
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
    	...
    	String mysign = "";
        if(DirectPayMobileCfg.SIGN_TYPE.equals("MD5") ) {
        	mysign = MD5.sign(prestr, CommonCfg.KEY, CommonCfg.INPUT_CHARSET);
        }
        if(DirectPayMobileCfg.SIGN_TYPE.equals("0001") ){
        	mysign = RSA.sign(prestr, DirectPayMobileCfg.PRIVATE_KEY, CommonCfg.INPUT_CHARSET);
        }
        return mysign;
    }
    ...
    private static Map<String, String> buildRequestPara(Map<String, String> sParaTemp) {
        ...
        if(! sPara.get("service").equals("alipay.wap.trade.create.direct") && ! sPara.get("service").equals("alipay.wap.auth.authAndExecute")) {
        	sPara.put("sign_type", DirectPayMobileCfg.SIGN_TYPE);
        }
    ...
    public static String buildRequest(String ALIPAY_GATEWAY_NEW, Map<String, String> sParaTemp, String strMethod, String strButtonName) {
        ...
        sbHtml.append("<form id=\"alipaysubmit\" name=\"alipaysubmit\" action=\"" + ALIPAY_GATEWAY_NEW
                      + "_input_charset=" + CommonCfg.INPUT_CHARSET + "\" method=\"" + strMethod
                      + "\">");
    ...
    public static String buildRequest(String ALIPAY_GATEWAY_NEW, String strParaFileName, String strFilePath,Map<String, String> sParaTemp) throws Exception {
        ...
        //设置编码集
        request.setCharset(CommonCfg.INPUT_CHARSET);

        request.setParameters(generatNameValuePair(sPara));
        request.setUrl(ALIPAY_GATEWAY_NEW+"_input_charset="+CommonCfg.INPUT_CHARSET);
    ...
    public static String getRequestToken(String text) throws Exception {
    	...
    	if (paraText.get("res_data") != null) {
    		...
    		if(DirectPayMobileCfg.SIGN_TYPE.equals("0001")) {
    			res_data = RSA.decrypt(res_data, DirectPayMobileCfg.PRIVATE_KEY, CommonCfg.INPUT_CHARSET);
    		}
	...
	public static String query_timestamp() throws MalformedURLException,
        ...
        String strUrl = "https://mapi.alipay.com/gateway.do?service=query_timestamp&partner=" + CommonCfg.PARTNER;
