...
public class AlipayNotify {
    ...
    public static Map<String, String> decrypt(Map<String, String> inputPara) throws Exception {
    	inputPara.put("notify_data", RSA.decrypt(inputPara.get("notify_data"), DirectPayMobileCfg.PRIVATE_KEY, CommonCfg.INPUT_CHARSET));
    	return inputPara;
    }
	...
	private static boolean getSignVeryfy(Map<String, String> Params, String sign, boolean isSort) {
        ...
        if(DirectPayMobileCfg.SIGN_TYPE.equals("MD5") ) {
        	isSign = MD5.verify(preSignStr, sign, CommonCfg.KEY, CommonCfg.INPUT_CHARSET);
        }
        if(DirectPayMobileCfg.SIGN_TYPE.equals("0001")){
        	isSign = RSA.verify(preSignStr, sign, DirectPayMobileCfg.ALI_PUBLIC_KEY, CommonCfg.INPUT_CHARSET);
        }
        return isSign;
    }
    ...
    */
    private static String verifyResponse(String notify_id) {
        ...
        String partner = CommonCfg.PARTNER;
