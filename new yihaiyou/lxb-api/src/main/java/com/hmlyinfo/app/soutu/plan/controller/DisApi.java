...
public class DisApi
{
	 ...
	 * 新增
	 * <ul>
	 * 	<li>url:/api/dis/add</li>
	 * </ul>
	 *
	 * @return
	 */
	@RequestMapping("/dis/add")
	public @ResponseBody ActionResult add(final HttpServletRequest request, final Dis domain)
	{
		service.edit(domain);
	 ...
	 * <ul>
	 * 	<li>必选:标识{id}<li>
	 *  <li>url:/api/dis/del</li>
	 * </ul>
	 *
	 * @return
	 */
	@RequestMapping("/dis/del")
	 ...
	 * <ul>
	 * 	<li>必选:标识{id}<li>
	 *  <li>url:/api/dis/edit</li>
	 * </ul>
	 *
	 * @return
	 */
	@RequestMapping("/dis/edit")
	public @ResponseBody ActionResult edit(final HttpServletRequest request, final Dis domain)
	{
	 ...
	 * 	<li>url:/api/dis/list</li>
	 * </ul>
	 * 
	 * @return 
	 */
	@RequestMapping("/dis/list")
	 ...
	 * <ul>
	 * 	<li>必选:标识{id}</li>
	 *  <li>url:/api/dis/info</li>
	 * </ul>
	 * 
	 * @return
	 */
	@RequestMapping("/dis/info")
