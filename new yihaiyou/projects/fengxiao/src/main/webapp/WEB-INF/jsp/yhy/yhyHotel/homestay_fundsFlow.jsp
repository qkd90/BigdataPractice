...
<body class="homestayFinance includeTable">
	...
	<div class="secnav">
		<div class="secnav_list">
			<ul class="clearfix">
				<li data-href="/yhy/yhyMain/toHomestayFinance.jhtml">财务账单</li>
				<li data-href="/yhy/yhyMain/toHomeFundsFlow.jhtml" class="HSsec_active">资金流水</li>
			</ul>
		</div>
	</div>
	<div class="financeList roomset">
		...
		<div class="selectBar">
			<div class="selB_1 search">
				<div class="btn-group">
					<button type="button" class="btn btn-default" onclick="HotelFundsFlow.search()">查询</button>
				</div>
			</div>
...
<script src="/js/yhy/yhyHotel/homestay_fundsflow.js"></script>
</html>