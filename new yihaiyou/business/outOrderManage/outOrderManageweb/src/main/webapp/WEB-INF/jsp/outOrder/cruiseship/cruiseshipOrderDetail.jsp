...
<head>
    ...
    <title>录入外接订单</title>
    <script type="text/javascript" src="/js/outOrder/cruiseship/cruseshipOrderDetail.js"></script>
</head>
<style type="text/css">
  body {
    font-size: 14px;
      ...
      <div style="width: 100%;height: 5%;padding: 15px;">
          ...
          <div style="width: 30%;float: right;">
              ...
              <div style="width: 46%; float: left;text-align: right;">
                  <a id="btn_confimOrder" onclick="CruseshipOrderDetail.confimOrder()" class="easyui-linkbutton" >确认订单</a>
                  <a id="btn_applyCancel" onclick="CruseshipOrderDetail.applyCancelDialog()" class="easyui-linkbutton" >主动退款</a>
              </div>
              <div style="width: 54%; float: right">
                  <a class="easyui-linkbutton" style="margin-left: 18px;" onclick="CruseshipOrderDetail.backParent()" >后退</a>
              </div>
          ...
          <div style="width: 100%;height: 15%;padding: 15px 15px;">
              ...
              <div style="width: 30%;float:right">
                  ...
                  <div>
                      ...
                      <a class="easyui-linkbutton" id="edit_actualPrice" style="margin-left: 18px;" onclick="CruseshipOrderDetail.editActualPayPrice()" >修改总额</a>
                  </div>
              </div>
          </div>
