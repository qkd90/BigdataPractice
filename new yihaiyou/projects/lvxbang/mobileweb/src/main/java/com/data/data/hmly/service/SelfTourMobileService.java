 ...
 */
@Service
public class SelfTourMobileService {
    ...
    public Map<String, Object> getStiData() {
        Map<String, Object> result = new HashMap<String, Object>();
        List<Ads> topBannerAds = advertisingService.getMobileStiBanner();
        List<Line> tuijianLines = lineService.getLineIndexLine("自助游首页-精品推荐", new Page(1, 2));
...
////        Set<TbArea> remenAreas = new HashSet<TbArea>();
