    ...
    <div class="detailTop">
        <div class="outrangestate">
            <div class="rangestate">
                您在这里：<a href="/yhypc/index/index.jhtml">首页</a> &gt;
                          <a href="/yhypc/plan/demand.jhtml"> DIY行程</a> &gt;
                          <a href="/yhypc/plan/scenicList.jhtml"> 厦门景点</a> &gt; ${scenicInfo.name}
            </div>
        </div>
        <div class="hotelbox clearfix">
            ...
            <div class="describ">
                ...
                <div class="price_book">
                    ...
                    <div class="tackdetail" id="tack_detail">加入行程</div>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript" src="/js/plan/planScenicDetail.js"></script>
...
<script type="text/html" id="ticket_list_item">
    <li class="clearfix">
        ...
        <div class="pri">
            ...
            <span class="pri_selected" data-id="{{id}}">加入行程</span>
        </div>
...
<script type="text/html" id="nearby_scenic_item">
    <li class="clearfix">
        <div class="picture"><a target="_blank" href="/yhypc/plan/scenicDetail.jhtml?scenicId={{id}}"><img src="{{cover | imageResize:82,86}}"></a></div>
        <div class="distance"><a target="_blank" href="/yhypc/plan/scenicDetail.jhtml?scenicId={{id}}"><p class="name">{{name}}</p></a>
