var editStep21 = {
	...
	doEditPrice : function(priceId) {
		var url = "/traffic/traffic/editStep2.jhtml?typePriceId=" + priceId + "&productId=" + $("#productId").val();
		window.location.href = url;	
	},
	// 上一步
	prevGuide:function(){
		var url = "/traffic/traffic/editStep2.jhtml?productId=" + $("#productId").val();
		window.location.href = url;	
	},	
	// 下一步
	nextGuide:function(){
		parent.window.showGuide(3, true, "/traffic/traffic/editStep3.jhtml?productId=" + $("#productId").val());
	}
};
