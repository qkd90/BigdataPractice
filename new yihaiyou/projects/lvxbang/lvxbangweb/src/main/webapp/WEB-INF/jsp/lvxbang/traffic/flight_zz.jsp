...
<body myname="mall" class="Order_hc_zz Order_fj Order_fj_zz">
    ...
    <div class="w1225 Order_hc_center" id="nav" style="margin-bottom: 70px">
        ...
        <div id="leave" style="display:none" class="Order_hc_c_fl Order_hc_zz_fl fl">
            <div class="Order_title">
                <b class="ff_yh">第一程</b>
                <span>${leaveCityName}->${transitCityName}</span><span id="span-leaveDate"
        ...
        <div id="return" style="display:none" class="Order_hc_c_fl Order_hc_zz_fr fr">
            <div class="Order_title">
                <b class="ff_yh">第二程</b>
                <span>${transitCityName}->${arriveCityName}</span><span id="span-returnDate"
    ...
    <div class="Order_hc_bottom cl" id="bottom">
        <div class="w1225">
            <div class="Order_hc_bottom_ul fl ">
                <ul>
                    <li>
                        <p class="xc qu fs16 b" style="width: 62px;height: 22px;font-size: 14px;text-align: center">
                            第一程</p>
                    ...
                    <li>
                        <p class="xc fan fs16 b" style="width: 62px;height: 22px;font-size: 14px;text-align: center">
                            第二程</p>
...
<script src="/js/lvxbang/traffic/flight_zz.js" type="text/javascript"></script>
